...
<form method="post" action="">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <div class="form-floating mb-3 mb-md-0">
                <input name="txtpassword" class="form-control" type="password" id="password" placeholder="Masukkan Pasword" />
    ...
    <?php
        if (@$_POST['simpan']) {
            ...
            mysqli_query($k,"INSERT INTO user(nama,username,password)VALUES('$nama','$user','$pass')");
